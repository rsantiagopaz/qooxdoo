 ...
 */
qx.Class.define("efisica.alumno.navpagTab",
{
  ...
  members :
  {
    ...
    _initialize : function()
    {
      ...
      var tabBar = this.tabBar = this.__createTabBar();
    ...
    __createTabBar : function()
    {
      ...
      */
      ...
      var tabButton1 = this.tabButton1 = new qx.ui.mobile.tabbar.TabButton("Datos");
      //tabButton1.setView(view1);

      var tabButton2 = this.tabButton2 = new qx.ui.mobile.tabbar.TabButton("Actividades");
      //tabButton2.setView(view2);

      var tabButton3 = this.tabButton3 = new qx.ui.mobile.tabbar.TabButton("Inscripciones");
      //tabButton3.setView(view3);

      var tabButton4 = this.tabButton4 = new qx.ui.mobile.tabbar.TabButton("Pagos");
