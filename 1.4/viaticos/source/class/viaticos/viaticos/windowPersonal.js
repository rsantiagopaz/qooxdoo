qx.Class.define("viaticos.viaticos.windowPersonal",
{
	...
	this.add(btnBuscar, {left: 270, top: 0});
		...
		tableModel.setColumns(["Ape/Nom (Dni)", "Cod.002", "Funcionario"], ["descrip", "codigo_002", "funcionario"]);
		...
		tbl.addListener("dataEdited", function(e){
			...
			var p = {id_personal: rowData.id_personal, codigo_002: rowDataAsMap.codigo_002, funcionario: rowDataAsMap.funcionario};
			var rpc = new qx.io.remote.Rpc("services/", "viaticos.Viaticos");
			try {
