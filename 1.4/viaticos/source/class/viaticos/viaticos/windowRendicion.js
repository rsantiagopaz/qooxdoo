qx.Class.define("viaticos.viaticos.windowRendicion",
{
	...
	var txtSubtotal_viatico2 = new qx.ui.form.Spinner(0, 0, 10000);
	...
	var txtSubtotal_alojam2 = new qx.ui.form.Spinner(0, 0, 10000);
	...
	var txtCombustible2 = new qx.ui.form.Spinner(0, 0, 10000);
	...
	var txtPasajes2 = new qx.ui.form.Spinner(0, 0, 10000);
	...
	var txtOtrosgastos2 = new qx.ui.form.Spinner(0, 0, 10000);
	...
	var ano, mes, dia;
	ano = parseInt(resultado.viatico.fecha_desde2.substr(0, 4));
	mes = parseInt(resultado.viatico.fecha_desde2.substr(5, 2)) - 1;
	dia = parseInt(resultado.viatico.fecha_desde2.substr(8, 2));
	...
	ano = parseInt(resultado.viatico.fecha_hasta2.substr(0, 4));
	mes = parseInt(resultado.viatico.fecha_hasta2.substr(5, 2)) - 1;
	dia = parseInt(resultado.viatico.fecha_hasta2.substr(8, 2));
