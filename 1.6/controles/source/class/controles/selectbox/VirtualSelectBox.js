 ...
 *   list.
 */
qx.Class.define("controles.selectbox.VirtualSelectBox",
{
  extend : controles.selectbox.AbstractVirtualBox,
  ...
  members :
  {
    ...
    */
    ...
    _addBindings : function()
    {
      ...
      var labelSourcePath = this._getBindPath("selection", "labelLargo");
      id = this.bind(labelSourcePath, atom, "label", this.getLabelOptions());
      this.__bindings.push(id);
      
      id = this.bind(labelSourcePath, this, "toolTipText", this.getLabelOptions());
      this.__bindings.push(id);
