 ...
 */
qx.Class.define("controles.selectbox.AbstractVirtualBox",
{
  ...
  members :
  {
    ...
    */
    ...
    _createChildControlImpl : function(id, hash)
    {
      ...
      {
        case "dropdown":
          control = new controles.selectbox.VirtualDropDownList(this);
          break;
      }
    ...
    */
    ...
    _applyChildProperty : function(value, old) {
      ...
      this.getChildControl("dropdown").getChildControl("list").setChildProperty(value);
      qx.ui.core.queue.Widget.add(this);
    },
